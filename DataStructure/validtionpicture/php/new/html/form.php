	 ...
	 <fieldset style="border: 1px solid red" >
	     <form class="form" action="validate.php">
		     <fieldset class="text">
				 ...
				 <input type="hidden" value="error!"/>
			     <label>验证码：</label>
			     <img id="captcha_img" style="border:1px sloid red;width:100px ;height:30px" src="../php/dot.php?r=<?php echo rand();?>" /> 
			     <a href="javascript:void(0)" onclick="document.getElementById('captcha_img').src='../php/dot.php?r='+Math.random()">看不清，换一个！</a>
